  ...
  <section class="sign-in container-fluid" >
    <div class="row" style="height: 100vh;">
        <div class="col-md-4 primary-bg d-md-flex d-none " >
            ...
            <img class=" w-auto" src="assets/img/forgot_hero.png"   alt="">
        </div>

        </div>
        <div class="col-md-8 my-auto">
            <div class="w-50 m-auto">
                <h3 class="header-color form-font font-weight-lighter">Forgot your password ?</h3>
                <small class="form-text" style="color: gray;">Masukkan alamat email Anda di bawah dan kami akan membantu Anda kembali</small>
            <form>
                <br>
